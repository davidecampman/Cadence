...
class Agent:
    ...
    def _system_prompt(self) -> str:
        ...
        prompt = (
            ...
            "- You CAN create, write, and modify files. Use write_file for text files, "
            "write_binary_file for binary content (base64-encoded), create_zip for ZIP "
            "archives, and execute_code to run scripts. NEVER say you cannot write files "
            "or create downloads — you have full file-creation capabilities.\n"
